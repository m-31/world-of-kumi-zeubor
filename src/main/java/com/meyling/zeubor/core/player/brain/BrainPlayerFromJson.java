...
public class BrainPlayerFromJson extends AdvancedAbstractBrainPlayer {
    
    public BrainPlayerFromJson(final int width, final int height, final String json) {
        super("unknown", width, height, new BrainFromJson(), json);
    }
