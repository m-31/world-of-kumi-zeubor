...
import com.meyling.zeubor.core.biology.brain.BrainImpl11;

import java.awt.*;

public class BrainPlayer11 extends AbstractBrainPlayer {
    
    public BrainPlayer11(final int width, final int height) {
        super("Dana", width, height, new BrainImpl11());
